...
// InitializeMachine handles VM initialization for GDC VMs. Currently, unimplemented.
func (p *Provider) InitializeMachine(_ context.Context, _ *driver.InitializeMachineRequest) (*driver.InitializeMachineResponse, error) {
	return nil, status.Error(codes.Unimplemented, "GDC Provider does not yet implement InitializeMachine")
}
